...
namespace BookTrader.Migrations
{
    ...
    [Migration("20250617200507_AddpasswordRequest")]
    partial class AddpasswordRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookTrader.Models.EstadoPublicacionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EstadoPublicacionEntity");
                });
            ...
            modelBuilder.Entity("BookTrader.Models.Libros", b =>
                {
                    ...
                    b.Property<string>("PublicadorId")
                        .IsRequired()
            ...
            modelBuilder.Entity("BookTrader.Models.PasswordResetRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookTrader.Models.PlanesSuscripcion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CantidadLibrosPorDia")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookTrader.Models.SubCategorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookTrader.Models.Users", b =>
                {
                    ...
                    b.Property<int?>("IdPlanSuscripcion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookTrader.Models.Libros", b =>
                {
                    ...
                    b.HasOne("BookTrader.Models.EstadoPublicacionEntity", "EstadoPublicacion")
                        .WithMany()
                    ...
                    b.HasOne("BookTrader.Models.Users", "Publicador")
                        .WithMany()
                        .HasForeignKey("PublicadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookTrader.Models.SubCategorias", "SubCategorias")
                        .WithMany()
            ...
            modelBuilder.Entity("BookTrader.Models.Users", b =>
                {
                    b.HasOne("BookTrader.Models.PlanesSuscripcion", "PlanesSuscripcion")
                        .WithMany()
                        .HasForeignKey("IdPlanSuscripcion");
                    ...
                    b.Navigation("PlanesSuscripcion");
                });
